...
![training_accuracy.png]({{site.url}}/_posts/training_accuracy.png)
...
![learning_rate.png]({{site.url}}/_posts/learning_rate.png)
...
![correct_pred1.png](https://raw.githubusercontent.com/kwotsin/kwotsin.github.io/master/_posts/correct_pred1.png)

![correct_pred2.png]({{site.url}}/_posts/correct_pred2.png)

![correct_pred3.png]({{site.url}}/_posts/correct_pred3.png)



##### Incorrect Predictions

![wrong_pred1.png]({{site.url}}/_posts/wrong_pred1.png)

![wrong_pred2.png]({{site.url}}/_posts/wrong_pred2.png)

![wrong_pred3.png]({{site.url}}/_posts/wrong_pred3.png)


#### TensorBoard Visualization (Evaluation)

![validation_accuracy.png]({{site.url}}/_posts/validation_accuracy.png)
